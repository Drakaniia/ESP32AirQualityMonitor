...
export function useSensorData(realData: {
  ...
  return {
    currentReading: simulation.isSimulationMode
      ? simulation.currentReading
      : realData.currentReading,
    historicalData: simulation.isSimulationMode
      ? simulation.simulatedData
      : realData.historicalData,
    deviceOnline: simulation.isSimulationMode
      ? simulation.deviceOnline
      : realData.deviceOnline,
    deviceCommands: simulation.isSimulationMode
      ? simulation.deviceCommands
      : realData.deviceCommands,
...
export function useAlertData(realAlerts: AlertEntry[]) {
  ...
  return {
    alerts: simulation.isSimulationMode
      ? simulation.simulatedAlerts
      : realAlerts,
    isSimulated: simulation.isSimulationMode,
  };
}
